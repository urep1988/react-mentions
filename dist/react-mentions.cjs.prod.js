...
var _generateComponentKey = function(usedKeys, id) {
  ...
  function Highlighter() {
    var _this;
    return _classCallCheck(this, Highlighter), (_this = _super.apply(this, arguments)).state = {
      lastPosition: {}
    }, _this;
  }
...
var SuggestionsOverlay = function(_Component) {
  ...
  function SuggestionsOverlay() {
    return _classCallCheck(this, SuggestionsOverlay), _super.apply(this, arguments);
  }
...
var makeTriggerRegex = function(trigger) {
  ...
  function MentionsInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getInputProps", function(isTextarea) {
      ...
      return _objectSpread$2(_objectSpread$2(_objectSpread$2({}, omit(_this.props, "style", keys(propTypes))), style("input")), {}, {

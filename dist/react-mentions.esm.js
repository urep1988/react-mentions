  ...
  _createClass(Highlighter, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", _extends({}, style, {
        style: _objectSpread(_objectSpread({}, inputStyle), style.style)
      }), resultComponents);
    }
  }, {
    key: "renderSubstring",
...
var SuggestionsOverlay = /*#__PURE__*/function (_Component) {
  ...
  _createClass(SuggestionsOverlay, [{
    ...
    value: function renderLoadingIndicator() {
      ...
      return /*#__PURE__*/React.createElement(LoadingIndicator$1, {
...
var MentionsInput = /*#__PURE__*/function (_React$Component) {
  ...
  function MentionsInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getInputProps", function (isTextarea) {
      ...
      return _objectSpread$2(_objectSpread$2(_objectSpread$2({}, props), style('input')), {}, {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderControl", function () {
      ...
      return /*#__PURE__*/React.createElement("div", style('control'), _this.renderHighlighter(inputProps.style), singleLine ? _this.renderInput(inputProps) : _this.renderTextarea(inputProps));
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "updateMentionsQueries", /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(plainTextValue, caretPosition) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                positionInValue = mapPlainTextIndex(value, config, caretPosition, 'NULL'); // If caret is inside of mention, do not query
              ...
              case 9:
                ...
                substringStartIndex = getEndOfLastMention(value.substring(0, positionInValue), config);
                substring = plainTextValue.substring(substringStartIndex, caretPosition); // Check if suggestions have to be shown:
                // Match the trigger patterns of all Mention children on the extracted substring

                promises = React.Children.map(children, /*#__PURE__*/function () {
                  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(child, childIndex) {
    ...
    _defineProperty(_assertThisInitialized(_this), "addMention", function (_ref4, _ref5) {
      ...
      var childIndex = _ref5.childIndex,
          querySequenceStart = _ref5.querySequenceStart,
          querySequenceEnd = _ref5.querySequenceEnd,
          plainTextValue = _ref5.plainTextValue;
...
export { Mention, MentionsInput$1 as MentionsInput, applyChangeToValue, countSuggestions, escapeRegex, findStartOfMentionInPlainText, getEndOfLastMention, getMentions, getPlainText, getSubstringIndex, isNumber, isObjectEqual, keys, makeMentionsMarkup, mapPlainTextIndex, markupToRegex, omit, readConfigFromChildren, spliceString };
